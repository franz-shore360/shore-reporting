...
return [
    ...
    'password_changed_subject' => 'Your :app password was changed',

    'password_changed_greeting' => 'Hello :name,',

    'password_changed_line' => 'The password for your :app account was just changed.',

    'password_changed_unknown' => 'If you did not make this change, contact your administrator immediately.',
